...
const Tabcontent = (props) => {
    ...
    if(items.data && items.data!==null){
        items.data.map((item) =>{
            ...
            if(mode==="homeSelf" && (item.mode==="home" ||  item.mode==="self")){
            ...
            else if(mode==="all" || item.mode===mode){
                if(date1.getTime()-fromDate.getTime()>=0 && toDate.getTime()-date1.getTime()>=0)
                {
                    filters.push(item)
                    if(item.mode==="income"){
                        ...
                        if(item.type==="CASH") ocash += parseInt(item.amount)
                        else obank += parseInt(item.amount)
                    }
                }
            }
            return item
                        ...
                        <Table className="tablestyle center" hover>
                                ...
                                <>
                                    <tr>
                                        <td colSpan="6">
                                            ...
                                            <div style={{width:"35%",float:"left"}}>UPI/CARD : {user.result.cashType}{ibank}</div>
                                        </td>
                                    </tr>
                                </>
                            }
                                ...
                                <>
                                    <tr>
                                        <td colSpan="6">
                                            ...
                                            <div style={{width:"35%",float:"left"}}>UPI/CARD : {user.result.cashType}{sebank}</div>
                                        </td>
                                    </tr>
                                </>
                            }
                                ...
                                <>
                                    <tr>
                                        <td colSpan="6">
                                            ...
                                            <div style={{width:"35%",float:"left"}}>UPI/CARD : {user.result.cashType}{hebank}</div>
                                        </td>
                                    </tr>
                                </>
                            }
                            {
                                ...
                                <>
                                    <tr>
                                        <td colSpan="6">
                                            <div style={{width:"30%",float:"left",fontWeight:"bolder"}}>OTHER EXPENSE</div>
                                            <div style={{width:"35%",float:"left"}}>Cash : {user.result.cashType}{ocash}</div>
                                            <div style={{width:"35%",float:"left"}}>UPI/CARD : {user.result.cashType}{obank}</div>
                                        </td>
                                    </tr>
                                </>
                            }
